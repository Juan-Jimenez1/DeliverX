...
public class ExpressStrategy implements RateStrategy {
    private static final double EXPRESS_BASE_RATE = 20000.0;  // Tarifa base express
    private static final double COST_PER_KG_EXTRA = 2000.0;   // Costo por kg adicional
    private static final double FREE_WEIGHT_KG = 5.0;         // Peso incluido sin cargo extra
    private static final double COST_PER_KM = 150.0; // costo por km
    ...
    public double calculate(Address origin, Address destination, double weight) {
        ...
        double totalCost = EXPRESS_BASE_RATE;
