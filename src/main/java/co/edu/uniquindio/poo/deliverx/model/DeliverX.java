...
public class DeliverX {
    ...
    public void addShipment(Shipment newShipment) {
            if (shipment != null) {
                ...
                System.out.println("✓ Shipment added to system: " + shipment.getIdShipment());

                // También agregar el envío a la lista del cliente
                if (shipment.getCustomer() != null) {
                    shipment.getCustomer().getShipmentList().add(shipment);
                }
            }
        }
    }
