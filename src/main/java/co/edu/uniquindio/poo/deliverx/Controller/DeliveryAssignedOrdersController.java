...
public class DeliveryAssignedOrdersController {
    ...
    public TableView assignedOrdersTable;
    public TableColumn orderIdColumn;
    public TableColumn destinationColumn;
    public TableColumn statusColumn;
    public TableColumn zoneColumn;
    public TableColumn dateColumn;
    public Label totalAssignedLabel;
    public Label completedTodayLabel;
    public Label inProgressLabel;
